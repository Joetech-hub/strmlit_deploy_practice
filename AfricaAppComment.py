...
def main():
    ...
    img = Image.open('africa_crises2.jpg')
    ...
    with col1:
        ...
        input_data['domestic_debt_in_default'] = st.number_input('Any Domestic Debt? If yes 1, if No, 0', min_value=0, max_value=1, step=1)
        input_data['sovereign_external_debt_default'] = st.number_input('Any Sovereign External Debt? if Yes 1, if No, 0', min_value=0, max_value=1, step = 1)
